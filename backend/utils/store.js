...
export const disableProducts = product =>{
    let bulkOptions = product.map(item =>{
        return {
            updateOne:{
                filter :{_id: item._id},
...
export const caculateTaxAmount = order =>{
    try {
...
export const caculateOrderTotal = order => {
...
export const caculateItemsSalesTax = items => {
    const taxRate = taxConfig.stateTaxRate;
